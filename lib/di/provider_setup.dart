...
import '../data/repository/info_api_respository_impl.dart';
...
List<SingleChildWidget> dependentModels = [
  ProxyProvider<http.Client, CoronaApi>(
    update: (context, client, _) => CoronaApi(client),
  ),
  ProxyProvider<CoronaApi, InfoApiRepository>(
  ...
  ProxyProvider<InfoApiRepository, GetMainInfoUseCase>(
    update: (context, repository, _) => GetMainInfoUseCase(repository),
  ),
];
...
List<SingleChildWidget> viewModels = [
  ChangeNotifierProvider<HomeViewModel>(
    create: (context) => HomeViewModel(
      context.read<GetInfosUseCase>(),
      context.read<GetMainInfoUseCase>(),
    ),
  ),
];
